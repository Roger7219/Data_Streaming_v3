...
CREATE TABLE  SSP_CLICK_DM_PHOENIX (
...
// Order: dwrGroupBy b_date aggExprsAlias l_time
@deprecated
case class SspClikDM (@BeanProperty var PUBLISHERID: Int,
  ...
  override def structType: StructType = SspClickDMSchema.structType
