...
class OverallMonthlyDataCheckHandler extends Handler{
  ...
  override def doHandle(): Unit = {
    ...
    messageClient.pull("overall_month_datacheck_cer", Array("overall_month_datacheck_topic"), { x =>
...
//      if(true){
      ...
      messageClient.push(new PushReq("overall_month_datacheck_topic", updateTime))
      true
    })
