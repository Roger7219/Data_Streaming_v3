...
//			System.out.println(entry.getKey()+":"+entry.getValue());
            ...
            try {
                ...
                System.out.println("encode exception:"+entry.getKey()+":"+entry.getValue());
                value = "";
            }
        ...
        try {
            ...
            System.out.println(e.getMessage()+"--"+urlStr);
        } finally {
            if (httpCon != null)
                httpCon.disconnect();
        }
    ...
    public static void main(String[] args) {
        ...
        String url = "http://ssp.mobikok.com/inter/SendEmail!sendEmail.action/SendEmail!sendEmail.action?title=test&content=我2&recipientAddress=2060878177@qq.com";
        HttpUtils.sendGet(url, new HashMap<String, String>());
        System.out.println();
