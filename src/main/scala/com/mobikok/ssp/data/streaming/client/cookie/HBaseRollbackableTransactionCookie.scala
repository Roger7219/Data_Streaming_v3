...
/**
  ...
  */
//class HBaseRollbackableTransactionCookie (_parentId:String,
//                                          _id: String,
...
//                             ) extends HBaseTransactionCookie(_parentId, _id){
//
//
...
//  @BeanProperty var transactionalProgressingBackupTable: String = _transactionalCompletedBackupTable
