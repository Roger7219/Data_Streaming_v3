...
//    )
    ...
    appId =  ifNull(source.get(("0","appId")).get, null,  Bytes.toInt(source.get(("0","appId")).get) + Int.MaxValue + 1)
    jarId =       ifNull(source.get(("0","jarId")).get, null,  Bytes.toInt(source.get(("0","jarId")).get) + Int.MaxValue + 1)
    jarIds = ifNull(source.get(("0","jarIds")).get, null,  OM.toBean(Bytes.toString(source.get(("0","jarIds")).get), new TypeReference[Array[Integer]] {} ) )
    ...
    version = ifNull(source.get(("0","version")).get, null,  Bytes.toString(source.get(("0","version")).get))
    model = ifNull(source.get(("0","model")).get, null,  Bytes.toString(source.get(("0","model")).get))
    screen = ifNull(source.get(("0","screen")).get, null,  Bytes.toString(source.get(("0","screen")).get))
    installType =  ifNull(source.get(("0","installType")).get, null,  Bytes.toInt(source.get(("0","installType")).get) + Int.MaxValue + 1)

    sv = ifNull(source.get(("0","sv")).get, null,  Bytes.toString(source.get(("0","sv")).get))
    leftSize = ifNull(source.get(("0","leftSize")).get, null,  Bytes.toString(source.get(("0","leftSize")).get))
    ...
    connectType = ifNull(source.get(("0","connectType")).get, null,  Bytes.toInt(source.get(("0","connectType")).get) + Int.MaxValue + 1)
    ...
    pkgName = ifNull(source.get(("0","pkgName")).get, null,  Bytes.toString(source.get(("0","pkgName")).get))
    ...
    pos = ifNull(source.get(("0","pos")).get, null,  Bytes.toInt(source.get(("0","pos")).get) + Int.MaxValue + 1)
