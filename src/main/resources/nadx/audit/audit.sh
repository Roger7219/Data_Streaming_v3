...
--conf spark.yarn.executor.memoryOverhead=2g  \
/apps/data-streaming/nadx/audit/data-streaming.jar \
audit.conf buration = 10 rate=10000 kill=true modules = nadx_audit