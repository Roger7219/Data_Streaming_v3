...
--verbose \
--conf spark.ui.port=1111 \
--conf spark.app.name=nadx_p_matched_dwi \
--conf spark.yarn.executor.memoryOverhead=1g \
/apps/data-streaming/nadx/dwi/data-streaming4match.jar \
dwi.conf buration = 20 kill=true modules = nadx_p_matched_dwi