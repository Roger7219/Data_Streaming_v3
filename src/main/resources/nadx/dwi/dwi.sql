...
CREATE TABLE nadx_traffic_dwi_v2(
repeats                           int,
rowkey                            string,
dataType                          int,
`timestamp`                       bigint,
...
-- 2019-5-3
-- dwi 新增
ALTER TABLE nadx_traffic_dwi ADD COLUMNS (event_count bigint);
ALTER TABLE nadx_traffic_dwi ADD COLUMNS (ssp_token STRING);
-- dwr 新增
...
//2019-07-04
ALTER TABLE nadx_overall_dwr ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_dwr ADD COLUMNS (rater_id STRING);
...
ALTER TABLE nadx_overall_dwr_v9 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_dwr_v9 ADD COLUMNS (rater_id STRING);
...
ALTER TABLE nadx_overall_traffic_dwi ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_traffic_dwi ADD COLUMNS (rater_id STRING);
ALTER TABLE nadx_overall_traffic_dwi ADD COLUMNS (adomain STRING);
ALTER TABLE nadx_overall_traffic_dwi_v9 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_traffic_dwi_v9 ADD COLUMNS (rater_id STRING);

ALTER TABLE nadx_traffic_dwi_40000 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_traffic_dwi_40000 ADD COLUMNS (rater_id STRING);
ALTER TABLE nadx_traffic_dwi_40000 ADD COLUMNS (adomain STRING);

ALTER TABLE nadx_traffic_dwi_40000 DROP  raterType;
ALTER TABLE nadx_traffic_dwi_40000 DROP  raterId;

ALTER TABLE nadx_overall_performance_matched_dwi_v9 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v9 ADD COLUMNS (rater_id STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v9 ADD COLUMNS (adomain STRING);

ALTER TABLE nadx_overall_dwr ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_overall_dwr_v9 ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_overall_traffic_dwi ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_overall_traffic_dwi_v9 ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_traffic_dwi_40000 ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v9 ADD COLUMNS (media_type STRING);



ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (raterType STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (raterId STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (adomain STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (rater_id STRING);
ALTER TABLE nadx_overall_performance_matched_dwi_v6 ADD COLUMNS (media_type STRING);


ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (raterType STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (raterId STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (adomain STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (rater_type STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (rater_id STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (media_type STRING);
ALTER TABLE nadx_overall_dwr_v6 ADD COLUMNS (site_domain STRING);
