...
--num-executors 4 \
--queue default \
--files /usr/hdp/current/spark2-client/conf/hive-site.xml,/apps/data-streaming/nadx/dwi/standby/dwi.conf \
--jars \
