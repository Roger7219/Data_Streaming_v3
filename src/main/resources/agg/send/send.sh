...
--conf spark.conf.app.name=agg_send \
/root/kairenlo/data-streaming/agg_send/data-streaming.jar \
/root/kairenlo/data-streaming/agg_send/send.conf
...
--conf spark.ui.port=9399 \
--conf spark.conf.app.name=agg_send \
--files /root/kairenlo/data-streaming/agg_send/send.conf \
/root/kairenlo/data-streaming/agg_send/data-streaming.jar \
send.conf
