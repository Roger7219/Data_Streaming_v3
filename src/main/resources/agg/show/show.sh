...
--verbose \
--conf spark.ui.port=9499 \
--conf spark.conf.app.name=agg_show \
/root/kairenlo/data-streaming/agg_show/data-streaming.jar \
/root/kairenlo/data-streaming/agg_show/show.conf
...
--conf spark.ui.port=9499 \
--conf spark.conf.app.name=agg_show \
--files /root/kairenlo/data-streaming/agg_show/show.conf \
/root/kairenlo/data-streaming/agg_show/data-streaming.jar \
show.conf
