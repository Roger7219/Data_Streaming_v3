...
--conf spark.conf.app.name=agg_traffic \
/root/kairenlo/data-streaming/agg_traffic/data-streaming.jar \
/root/kairenlo/data-streaming/agg_traffic/traffic.conf
...
--conf spark.ui.port=9599 \
--conf spark.conf.app.name=agg_traffic \
--files /root/kairenlo/data-streaming/agg_traffic/traffic.conf \
/root/kairenlo/data-streaming/agg_traffic/data-streaming.jar \
traffic.conf
