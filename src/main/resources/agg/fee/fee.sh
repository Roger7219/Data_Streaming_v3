...
--verbose \
--conf spark.ui.port=9699 \
--conf spark.conf.app.name=agg_fee \
/root/kairenlo/data-streaming/agg_fee/data-streaming.jar \
/root/kairenlo/data-streaming/agg_fee/fee.conf
...
--conf spark.ui.port=9699 \
--conf spark.conf.app.name=agg_fee \
--files /root/kairenlo/data-streaming/agg_fee/fee.conf \
/root/kairenlo/data-streaming/agg_fee/data-streaming.jar \
fee.conf
