...
--conf spark.conf.app.name=agg_click \
/root/kairenlo/data-streaming/agg_click/data-streaming.jar \
/root/kairenlo/data-streaming/agg_click/click.conf
...
--conf spark.ui.port=9599 \
--conf spark.conf.app.name=agg_click \
--files /root/kairenlo/data-streaming/agg_click/click.conf \
/root/kairenlo/data-streaming/agg_click/data-streaming.jar \
click.conf
