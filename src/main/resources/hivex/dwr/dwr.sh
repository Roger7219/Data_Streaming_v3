...
--num-executors 1 \
--queue default \
--files /usr/hdp/current/spark2-client/conf/hive-site.xml,/apps/data-streaming/hivex/dwr/dwr.conf \
--jars \
...
--conf spark.app.name=hivex_overall \
--conf spark.yarn.executor.memoryOverhead=2g  \
/apps/data-streaming/hivex/dwr/data-streaming.jar \
dwr.conf buration = 150 kill=true modules = hivex_traffic offset=latest