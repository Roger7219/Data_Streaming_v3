...
CREATE TABLE SSP_OVERALL_EVENTS_DWI_PHOENIX(
    "repeats"     INTEGER   ,
    "rowkey"      VARCHAR,
...
disable 'SSP_OVERALL_EVENTS_DWI_PHOENIX'
-- 7天
alter 'SSP_OVERALL_EVENTS_DWI_PHOENIX',{NAME=>'0',TTL=>'604800'}
alter 'SSP_OVERALL_EVENTS_DWI_PHOENIX', NAME => '0', COMPRESSION => 'snappy'


enable 'SSP_OVERALL_EVENTS_DWI_PHOENIX'
