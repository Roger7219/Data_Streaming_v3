...
--conf spark.conf.app.name=events2hbase \
/root/kairenlo/data-streaming/ssp/events2hbase/data-streaming.jar \
/root/kairenlo/data-streaming/ssp/events2hbase/events2hbase.conf
