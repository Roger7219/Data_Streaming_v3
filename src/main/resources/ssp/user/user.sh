...
--conf spark.conf.app.name=ssp_user \
/root/kairenlo/data-streaming/ssp/user/data-streaming.jar \
/root/kairenlo/data-streaming/ssp/user/user.conf
...
--conf spark.conf.app.name=ssp_user \
--files /root/kairenlo/data-streaming/ssp/user/user.conf \
/root/kairenlo/data-streaming/ssp/user/data-streaming.jar \
user.conf kill=true buration=100
