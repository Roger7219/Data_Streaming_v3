...
--conf spark.conf.app.name=dw_log \
/root/kairenlo/data-streaming/dw_log/data-streaming.jar \
/root/kairenlo/data-streaming/dw_log/dw.log.conf
...
--conf spark.ui.port=3777 \
--conf spark.conf.app.name=dw_log \
--files /root/kairenlo/data-streaming/dw_log/dw.log.conf \
/root/kairenlo/data-streaming/dw_log/data-streaming.jar \
dw.log.conf