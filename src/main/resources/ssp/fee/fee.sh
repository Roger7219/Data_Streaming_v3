...
--conf spark.conf.app.name=fee \
/root/kairenlo/data-streaming/ssp/fee/data-streaming.jar \
/root/kairenlo/data-streaming/ssp/fee/fee.conf
...
--conf spark.ui.port=1111 \
--conf spark.conf.app.name=fee \
--files /root/kairenlo/data-streaming/ssp/fee/fee.conf \
/root/kairenlo/data-streaming/ssp/fee/data-streaming.jar \
fee.conf
