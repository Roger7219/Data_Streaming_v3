...
disable 'SSP_SEND_DWI_PHOENIX'
-- 10天
alter 'SSP_SEND_DWI_PHOENIX',{NAME=>'0',TTL=>'864000'}
alter 'SSP_SEND_DWI_PHOENIX', NAME => '0', COMPRESSION => 'snappy'


enable 'SSP_SEND_DWI_PHOENIX'


create 'SSP_SEND_DWI_PHOENIX_V2', '0'

create 'SMART_DATA_VO_DWI_PHOENIX', '0'
create 'SSP_OVERALL_POSTBACK_DWI_PHOENIX', '0'
create 'SSP_OVERALL_EVENTS_DWI_PHOENIX', '0'
create 'SSP_SEND_DWI_PHOENIX_V1', '0'
