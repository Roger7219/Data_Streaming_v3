...
//    sendMsg_btimes_for_ck("nadx_overall_dwr", "2019-03-29 00:00:00", "2019-03-29 23:00:00", "nadx_ck")
//    sendMsg_btimes_for_ck("nadx_overall_dwr", "2019-03-22 00:00:00", "2019-03-22 23:00:00", "nadx_ck")


//    sendMsg_btimes_for_ck("nadx_overall_dwr", "2019-03-21 00:00:00", "2019-03-21 23:00:00", "nadx_ck")
//    sendMsg_btimes_for_ck("nadx_overall_dwr", "2019-03-20 00:00:00", "2019-03-20 23:00:00", "nadx_ck")

    // SSP clickhouse overall数据刷新
//    sendMsg_btimes_for_ck("ssp_report_overall_dwr", "2019-04-09 00:00:00", "2019-04-09 23:00:00", "ck_report_overall")

    // SSP bigquery publisher&campaign  和 clickhouse overall天表刷新
//    sendMsg_btime_00_00_00_for_day_bq_and_ck("ssp_report_overall_dwr_day", "2019-04-09", "2019-04-09", "bq_report_overall", "bq_report_overall_day_v2", "ck_report_overall_day", "bq_report_mix")
