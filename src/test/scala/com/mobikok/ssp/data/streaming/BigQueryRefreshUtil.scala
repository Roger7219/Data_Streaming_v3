...
//    sendMsg_btime("update_ssp_report_overall", "2018-01-16 20:00:00")
...
//    sendMsg_btime_00_00_00("bq_report_publisher_update", "2018-07-10", "2018-07-10")
    ...
    //
//    sendMsg_btime_00_00_00("ssp_report_overall_dwr_day", "2018-06-05", "2018-06-05")
...
//    sendMaxWaitingTimeMS(DynamicConfig.of("ssp_report_overall_dm_month", DynamicConfig.BATCH_PROCESSING_TIMEOUT_MS), String.valueOf(1000*60*60*100L)) // 4小时
    sendMaxWaitingTimeMS(DynamicConfig.of("ck_report_overall_day", DynamicConfig.BATCH_PROCESSING_TIMEOUT_MS), String.valueOf(1000*60*60*12L)) // 4小时
...
//    sendMsg_btime("ck_report_overall_day", "2016-10-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2016-11-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2016-12-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-01-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-02-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-03-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-04-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-05-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-06-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-07-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-08-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-09-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-10-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-11-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2017-12-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-01-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-02-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-03-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-04-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-05-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-06-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-07-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-08-01 00:00:00")
//    sendMsg_btime("ck_report_overall_day", "2018-09-01 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-01 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-02 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-03 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-04 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-05 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-06 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-07 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-08 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-09 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-10 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-11 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-12 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-13 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-14 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-15 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-16 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-17 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-18 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-19 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-20 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-21 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-22 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-23 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-24 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-25 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-26 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-27 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-28 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-29 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-30 00:00:00")
    sendMsg_btime("ck_report_overall_day", "2018-10-31 00:00:00")
